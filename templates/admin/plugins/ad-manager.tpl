			...
			<div class="table-responsive">
				<table class="table table-hover table-striped mb-0 align-middle w-100" style="min-width: 1000px;">
					...
					<tbody id="ad-units-tbody">
						{{{each ads}}}
						<tr class="ad-unit-row" data-id="{ads.id}" data-location="{ads.location}" data-page-target="{ads.pageTarget}" data-device-target="{ads.deviceTarget}">
							...
							<td>
								...
								<div class="text-center">
									<img src="{ads.image}" class="ad-preview-img img-thumbnail" style="max-height: 40px; max-width: 120px; display: none; margin: 0 auto;" alt="תצוגה מקדימה">
								</div>
							</td>
							<td>
